...
// 异步模块加载
let ToolSandbox, ToolValidator, ToolUtils, PnpmInstaller, ToolInterface, PnpmWrapper;
...
async function initializeModules() {
  if (!ToolSandbox) {
    ...
    PnpmWrapper = require('./PnpmWrapper');  // 导入包装器
  }
}
...
module.exports = {
  ...
  get PnpmWrapper() { return PnpmWrapper; },
